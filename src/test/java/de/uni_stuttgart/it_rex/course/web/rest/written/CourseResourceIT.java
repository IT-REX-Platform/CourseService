...
public class CourseResourceIT {
    ...
    public void updateCourse() throws Exception {
        ...
        updatedCourse.setRemainActiveOffset(course.getRemainActiveOffset());
        updatedCourse.setMaxFoodSum(UPDATED_MAX_FOOD_SUM);
        updatedCourse.setCourseDescription(COURSE_DESCRIPTION);
        updatedCourse.setPublishState(course.getPublishState());
